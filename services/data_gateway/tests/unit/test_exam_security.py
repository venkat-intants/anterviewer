...
def test_public_take_models_have_no_answer_key_fields() -> None:
    """None of the applicant-facing response models may carry correct_index or
    pass_threshold (defence against accidentally widening the schema later)."""
    from app.routers.exam_take import ExamResultOut, PublicQuestionOut, TakeExamOut

    for model in (PublicQuestionOut, TakeExamOut, ExamResultOut):
