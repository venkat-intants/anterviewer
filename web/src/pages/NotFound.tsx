    ...
    >
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <p className="text-6xl font-bold text-primary/30 select-none">404</p>
          <h1 id="not-found-heading" className="text-2xl font-semibold text-foreground">
            {t('error.pageNotFoundTitle')}
          </h1>
          <p className="text-sm text-muted-foreground">{t('error.pageNotFoundDesc')}</p>
        </motion.div>
